                ...
                <div className="space-y-3">
                  <div className="flex gap-3">
                    <button
                      ...
                      className={`flex-1 flex flex-col items-center gap-2 py-4 px-2 border transition-colors ${paymentMethod === 'googlepay' ? 'border-[#DC2626] bg-[#FEF2F2]' : 'border-[#FECACA] bg-white hover:border-[#FCA5A5]'}`}
                    >
                      <img src="/pay-google.svg" alt="Google Pay" className="h-7 w-auto" />
                      <span className="text-xs text-[#111827] font-medium">{t.payGooglePay}</span>
                    </button>

                    <button
                      type="button"
                      onClick={() => setPaymentMethod('applepay')}
                      className={`flex-1 flex flex-col items-center gap-2 py-4 px-2 border transition-colors ${paymentMethod === 'applepay' ? 'border-[#DC2626] bg-[#FEF2F2]' : 'border-[#FECACA] bg-white hover:border-[#FCA5A5]'}`}
                    >
                      <img src="/pay-apple.svg" alt="Apple Pay" className="h-7 w-auto" />
                      <span className="text-xs text-[#111827] font-medium">{t.payApplePay}</span>
                    </button>
                  </div>

                  <div className="flex items-center gap-3">
                    <div className="flex-1 h-px bg-[#FECACA]" />
                    <span className="text-xs text-[#6B7280]">{t.payOr}</span>
                    <div className="flex-1 h-px bg-[#FECACA]" />
                  </div>

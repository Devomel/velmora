            ...
            {visible.map(p => {
              ...
              return (
                <div key={p.id} className="bg-white border border-[#FECACA] hover:border-[#DC2626] hover:shadow-lg transition-all duration-200 flex flex-col">
                  {/* Image */}
                  <Link href={`/land2/product/${p.id}`} className="relative block overflow-hidden bg-white group" style={{ height: '220px' }}>
                    {p.badge && (
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    ...
                    <Link href={`/land2/product/${p.id}`} className="hover:text-[#DC2626] transition-colors">
